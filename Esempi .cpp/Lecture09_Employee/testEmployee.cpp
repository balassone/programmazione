...
int main() {
   cout << std::fixed << std::setprecision(2); // set floating-point formatting

   // create derived-class objects                        
   SalariedEmployee salariedEmployee{
      "Paul", "Chambers", "111-11-1111", 800};
   CommissionEmployee commissionEmployee{
      "Bill", "Evans", "333-33-3333", 10000, .06};
   BasePlusCommissionEmployee basePlusCommissionEmployee{
      "Miles", "Davis", "444-44-4444", 5000, .04, 300};
