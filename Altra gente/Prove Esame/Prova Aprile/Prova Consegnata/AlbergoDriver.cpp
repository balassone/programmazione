...
void insertBooking(const string&n, const string&card, int cat, const Date&pren);
...
int main(){
    ...
    Cliente c1{"Franco Dergado ", "522666444888", {22,01,22}};
    Cliente c2{"Giovanni Lorenzo ", "669988771122", {27,05,22}};
    Cliente c3{"Ettore Silvestro ", "332255446667", {24,03,22}};
    Cliente c4{"Donato DelVecchio ", "778855664422", {23,01,22}};
    Cliente c5{"Franco Tristezza ", "663322441157", {15,06,22}};
    Cliente c6{"Kevin Peperonata ", "786465132184", {11,05,22}};


    a1.inserisciCliente(c1);
    a1.inserisciCliente(c2);

    a3.inserisciCliente(c3);
    ...
    insertBooking("Giovanni Muciacia", "78945612472", 4, {18,02,22});
}
...
void insertBooking(const string&n, const string&card, int cat, const Date&pren, vector<Albergo*>&A){ // funzione per l'inserimento di una prenotazione
    ...
    (isInserted) ? cout << "Cliente inserito correttamente" : cout <<"Non è stato possibile inserire il cliente";
}
